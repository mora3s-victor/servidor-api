...
public class ServidorEfetivoService {
    ...
    @Transactional(readOnly = true)
    public Page<ServidorEfetivoUnidadeDTO> findByUnidade(Long unidadeId, Pageable pageable) {
        return servidorEfetivoRepository.findByUnidadeId(unidadeId, pageable)
                .map(this::toUnidadeDTO);
    }

    @Transactional(readOnly = true)
    public Page<ServidorEfetivoDTO> findByNome(String nome, Pageable pageable) {
        return servidorEfetivoRepository.findByPessoaNomeContainingIgnoreCase(nome, pageable)
                .map(this::toDTO);
    }
    ...
    public ServidorEfetivoDTO create(ServidorEfetivoDTO dto) {
        ...
        // 3. Criar e salvar servidor efetivo
        ...
        servidor = servidorEfetivoRepository.save(servidor);
    ...
    @Transactional
    public ServidorEfetivoDTO update(Long id, ServidorEfetivoDTO dto) {
    ...
    public void uploadFoto(Long servidorId, MultipartFile foto) throws Exception {
        ServidorEfetivo servidor = servidorEfetivoRepository.findById(servidorId)
                .orElseThrow(() -> new ResourceNotFoundException("Servidor efetivo não encontrado"));
    ...
    private ServidorEfetivoDTO toDTO(ServidorEfetivo servidor) {
    ...
    private ServidorEfetivoUnidadeDTO toUnidadeDTO(ServidorEfetivo servidor) {
        ServidorEfetivoUnidadeDTO dto = new ServidorEfetivoUnidadeDTO();
        dto.setId(servidor.getId());
        dto.setNome(servidor.getPessoa().getNome());
